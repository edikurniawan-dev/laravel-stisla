...
@push('scripts')
    <script src="{{ asset('js/library/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('js/library/Chart.min.js') }}"></script>
    <script src="{{ asset('js/library/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('js/library/jquery.vmap.world.js') }}"></script>
