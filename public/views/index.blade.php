...
<head>
    ...
    <!-- CSS Libraries -->
    {{-- <link rel="stylesheet"
        href="../node_modules/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet"
    ...
    @vite('../../node_modules/jqvmap/dist/jqvmap.min.css')
    @vite('../../node_modules/summernote/dist/summernote-bs4.css')
    @vite('../../node_modules/summernote/dist/summernote-bs4.css')
    @vite('../../node_modules/owl.carousel/dist/assets/owl.theme.default.min.css')
...
<body>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link"
                                        href="components-article.html">Article</a></li>
                                <li><a class="nav-link beep beep-sidebar"
                                        href="components-avatar.html">Avatar</a></li>
                                <li><a class="nav-link"
                                        href="components-chat-box.html">Chat Box</a></li>
                                <li><a class="nav-link beep beep-sidebar"
                                        href="components-empty-state.html">Empty State</a></li>
                                <li><a class="nav-link"
                                        href="components-gallery.html">Gallery</a></li>
                                <li><a class="nav-link beep beep-sidebar"
                                        href="components-hero.html">Hero</a></li>
                                <li><a class="nav-link"
                                        href="components-multiple-upload.html">Multiple Upload</a></li>
                                <li><a class="nav-link beep beep-sidebar"
                                        href="components-pricing.html">Pricing</a></li>
                                <li><a class="nav-link"
                                        href="components-statistic.html">Statistic</a></li>
                                <li><a class="nav-link"
                                        href="components-tab.html">Tab</a></li>
                                <li><a class="nav-link"
                                        href="components-table.html">Table</a></li>
                                <li><a class="nav-link"
                                        href="components-user.html">User</a></li>
                                <li><a class="nav-link beep beep-sidebar"
                                        href="components-wizard.html">Wizard</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                                                <li class="media">
                                                    <img class="img-fluid img-shadow mt-1"
    ...
    <!-- JS Libraies -->
    @vite('../../node_modules/jquery-sparkline/jquery.sparkline.min.js')
    @vite('../../node_modules/chart.js/dist/Chart.min.js')
    @vite('../../node_modules/owl.carousel/dist/owl.carousel.min.js')
    @vite('../../node_modules/summernote/dist/summernote-bs4.js')
    @vite('../../node_modules/chocolat/dist/js/jquery.chocolat.min.js')
